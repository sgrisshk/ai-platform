...
**Resolution:** *(partial — R1 and R5 resolved below by ARCHITECT; R2, R3, and R4 remain open with
their originally named owners. This handoff stays `OPEN` and stays `Blocking: YES`: `ADR-061`/§8
require **all five** items cleared before either preregistered run may be issued, and nothing here
authorizes issuance.)*
