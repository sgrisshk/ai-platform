...
- **Note (2026-08-13, Statistics):** `TASK-013` fixed `contribution_margin_eur` as the primary
  outcome for the synthetic benchmark only (`docs/analytics/outcome-contract.md`) — the fullest realized,
...
- **Note (2026-08-13, Product):** `docs/product/finding-product-contract.md` §11 confirms Product cannot supply a real number from synthetic data alone; redirected to Customer Discovery as `HANDOFF-021`, gated on `TASK-057`.
